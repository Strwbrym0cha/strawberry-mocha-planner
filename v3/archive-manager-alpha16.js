...
let queued=false;const observer=new MutationObserver(()=>{if(queued)return;queued=true;requestAnimationFrame(()=>{queued=false;renderManager()})});if(app)observer.observe(app,{childList:true,subtree:true});renderManager();
