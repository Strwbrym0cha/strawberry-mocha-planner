...
let coreReady=false;
try{
  await import('./money-ui.js?v=3.0.0-alpha.16-wake2');
  coreReady=true;
}catch(error){
...
if(coreReady){try{await import('./money-alpha9-extras.js?v=3.0.0-alpha.16-wake2')}catch(error){console.warn('Money Cafe optional extras failed; core remains available.',error)}}