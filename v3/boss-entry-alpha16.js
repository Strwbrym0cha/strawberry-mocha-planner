...
let coreReady=false;
try{
  await import('./boss-ui.js?v=3.0.0-alpha.16-wake2');
  coreReady=true;
}catch(error){
...
if(coreReady){try{await import('./boss-alpha9-extras.js?v=3.0.0-alpha.16-wake2')}catch(error){console.warn('Boss Bitch optional extras failed; core remains available.',error)}}