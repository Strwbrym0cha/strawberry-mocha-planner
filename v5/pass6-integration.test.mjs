...
assert.equal(mochiniAvatar.includes('mochini-brow')&&mochiniAvatar.includes('mochini-face-fx'),true,'Mochini expression pack uses small facial layers rather than replacing canonical art');
