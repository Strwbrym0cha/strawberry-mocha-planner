...
assert.match(indexSource,/bootstrap\.js\?v=7\.0\.8-phone-canonical-bootstrap/,'iOS containers receive the guarded phone-bootstrap build instead of a cached recovery preview');
...
assert.match(appSource,/data\.js\?v=7\.0\.8-phone-canonical-bootstrap/);assert.match(appSource,/rooms\.js\?v=7\.0\.0-safe-sync-foundation/);
