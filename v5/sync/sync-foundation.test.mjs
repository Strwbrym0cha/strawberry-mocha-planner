...
assert.match(indexSource,/bootstrap\.js\?v=7\.0\.4-recovery-plan-hardened/,'iOS containers receive the hardened read-only recovery-plan bootstrap instead of a cached build');
