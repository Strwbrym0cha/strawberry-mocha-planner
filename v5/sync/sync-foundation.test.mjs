...
assert.match(indexSource,/bootstrap\.js\?v=7\.0\.5-final-recovery-readiness/,'iOS containers receive the final read-only recovery-readiness bootstrap instead of a cached build');
