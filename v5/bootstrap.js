...
await import('./gig-goals-fix.js?v=7.0.17-gig-goal-edit');
...
await import('./doordash-shift-modal.js?v=7.0.18-unified-gig-planner');
await import('./flex-shift-modal.js?v=7.0.18-unified-gig-planner');
await import('./unified-gig-planner.js?v=7.0.18-unified-gig-planner');
