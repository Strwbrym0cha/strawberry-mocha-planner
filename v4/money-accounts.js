...
function total(accounts,state){const live=window.__KATOS_V4_MONEY_LEDGER?.summary?.(state);return live?live.available:accounts.reduce((sum,a)=>sum+Number(a.balance||0),0)}
