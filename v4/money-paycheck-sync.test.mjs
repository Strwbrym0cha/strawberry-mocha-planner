...
import{receivedAmount,normalizePaycheckCompatibility,repairPaycheckCompatibility,syncPaycheckIntoExistingLedger}from'./money-paycheck-sync.js';
...
const withLedger={money:{ledger:[{id:'legacy-ledger-1',kind:'income',label:'Paycheck',amount:275,date:'2026-08-28',category:'Other',note:'Training pay'}]}};
...
const emptyLedger={money:{ledger:[]}};
