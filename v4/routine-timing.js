...
document.addEventListener('click',e=>{const save=e.target.closest?.('[data-routine-timing-save]');if(save){saveTiming(save.dataset.routineTimingSave);return}const archive=e.target.closest?.('[data-routine-archive]');if(archive){archiveRoutine(archive.dataset.routineArchive);return}const del=e.target.closest?.('[data-routine-delete]');if(del)deleteRoutine(del.dataset.routineDelete)},true);
