const CACHE='katos-v4-root-tools2-hobbytypefix1';
...
const CORE=[
  ...
  url('./v4/loader.js?v=4.0.0-parity3-tools2-hobbytypefix1'),
  url('./v4/store.js?v=4.0.0-hobbytypefix1'),
  ...
  url('./v4/routine-timing.js?v=4.0.0-routetime2'),
  url('./v4/hobby-types.js?v=4.0.0-hobbytypes1'),
  url('./v4/hobby-shelf.js?v=4.0.0-hobbyshelf1'),
