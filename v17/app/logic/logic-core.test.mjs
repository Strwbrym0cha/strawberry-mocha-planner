...
const events=dataUrl(replace(await source('./events.js'),"'../data.js?v=22.1.16-20260817'",`'${data}'`));
const tasks=dataUrl(replace(replace(await source('./tasks.js'),"'../data.js?v=22.1.16-20260817'",`'${data}'`),"'./events.js'",`'${events}'`));
...
evaluateCode=replace(evaluateCode,"'../data.js?v=22.1.16-20260817'",`'${data}'`);
