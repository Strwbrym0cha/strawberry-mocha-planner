...
const events=dataUrl(replace(await source('./events.js'),"'../data.js?v=22.1.15-20260817'",`'${data}'`));
const tasks=dataUrl(replace(replace(await source('./tasks.js'),"'../data.js?v=22.1.15-20260817'",`'${data}'`),"'./events.js'",`'${events}'`));
const routines=dataUrl(replace(await source('./routines.js'),"'../data.js?v=22.1.15-20260817'",`'${data}'`));
const deadlines=dataUrl(replace(await source('./deadlines.js'),"'../data.js?v=22.1.15-20260817'",`'${data}'`));
const finance=dataUrl(replace(await source('./finance.js'),"'../data.js?v=22.1.15-20260817'",`'${data}'`));
let evaluateCode=await source('./evaluate-today.js');
evaluateCode=replace(evaluateCode,"'../data.js?v=22.1.15-20260817'",`'${data}'`);
evaluateCode=replace(evaluateCode,"'./events.js'",`'${events}'`);
evaluateCode=replace(evaluateCode,"'./deadlines.js'",`'${deadlines}'`);
evaluateCode=replace(evaluateCode,"'./routines.js'",`'${routines}'`);
evaluateCode=replace(evaluateCode,"'./tasks.js'",`'${tasks}'`);
