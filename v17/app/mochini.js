...
export function buildMochiniPresentation(evaluation,state={}){
 ...
 const notices=[];
 if(evaluation?.hyperfixation?.active)notices.push(`Hyperfixation Mode is on: ${evaluation.hyperfixation.focus?.label||'your current focus'}.`);
