...
const suggested=noms.plannedNomSuggestion(state,'2026-08-17');assert.equal(suggested.label,'Quesadillas deluxe');assert.equal(suggested.nom.id,nomId,'a meal-plan suggestion reuses the saved Nom reference');assert.equal(noms.plannedNomSuggestion(state,'2026-08-18'),null,'an empty date is not given a made-up suggestion');
