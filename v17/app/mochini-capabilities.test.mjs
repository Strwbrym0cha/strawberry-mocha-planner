...
const baseState={
 tasks:[{id:'task1',text:'Finish work video',date:'2026-08-18',done:false}],
 events:[],
...
const context={state:baseState,evaluation:{date:'2026-08-18',recommendedNextAction:recommendation,state:{capacity:'High'},candidates:[recommendation]},session:{}};
